...
import type { Camera, Scene, WebGLRenderer, WebGLRendererParameters } from 'three';
...
import type { PointerInterface, PointerPublicConfigInterface } from './usePointer';
import useThree from './useThree';
import type { SizeInterface, ThreeConfigInterface, ThreeInterface } from './useThree';
...
export default defineComponent({
  ...
  computed: {
    ...
    composer: {
      get: function (): EffectComposer | undefined {
        return this.three.composer;
      },
      set: function (composer: EffectComposer): void {
