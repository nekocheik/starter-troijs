...
type WatchStopHandle = any;
type OptionSetter = (dst: any, key: string, value: any) => void;

export function applyObjectProps(dst: any, options: Record<string, unknown>, setter?: OptionSetter): void {
...
export function bindObjectProp(src: any, prop: string, dst: any, apply = true, setter?: OptionSetter): WatchStopHandle {
...
export function bindObjectProps(src: any, dst: any, apply = true, setter?: OptionSetter): WatchStopHandle {
