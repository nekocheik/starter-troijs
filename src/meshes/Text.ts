...
import type { MeshSetupInterface } from './Mesh';
...
export default defineComponent({
  ...
  created() {
    ...
    // add watchers
    const watchProps = ['text', 'size', 'height', 'curveSegments', 'bevelEnabled', 'bevelThickness', 'bevelSize', 'bevelOffset', 'bevelSegments', 'align'];
